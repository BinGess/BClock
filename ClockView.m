...
- (void)setHourHandImage:(CGImageRef)image
{
	if (image == NULL) {
		...
		hourHand.backgroundColor = [UIColor colorWithRed:0.99 green:0.41 blue:0.40 alpha:1.0].CGColor;
...
{
	if (image == NULL) {
		minHand.backgroundColor = [UIColor colorWithRed:0.99 green:0.41 blue:0.40 alpha:1.0].CGColor;
	}else{
...
{
	if (image == NULL) {
		secHand.backgroundColor = [UIColor colorWithRed:0.99 green:0.41 blue:0.40 alpha:1.0].CGColor;
...
//        [self setHourHandImage:[UIImage imageNamed:@"clock-hour-background.png"].CGImage];
//        [self setMinHandImage:[UIImage imageNamed:@"clock-min-background.png"].CGImage];
//        [self setSecHandImage:[UIImage imageNamed:@"clock-sec-background.png"].CGImage];
